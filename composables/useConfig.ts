...
const defaultConfig: DefaultConfig = {
  site: {
    name: 'CampusDigitalFP',
    description: 'Realizando pruebas para la creación de una plataforma para nuestro centro. Open Source.',
    ogImage: '/hero.png',
  ...
  banner: {
    enable: false,
    showClose: true,
    content: 'Welcome to **CampusDigitalFP**',
    to: '',
    target: '_blank',
    border: true,
  },
